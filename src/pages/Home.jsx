...
const Home = () => {
  ...
  return (
    <motion.div
      ...
      className="bg-black text-primary font-sans"
    >
      {/* Hero Section */}
      <header className="relative min-h-[90vh] flex flex-col justify-center items-center px-6 pt-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center w-full z-10 flex flex-col items-center">
          ...
          <motion.p 
            ...
            className="font-sans text-xl md:text-2xl text-primary/70 max-w-2xl mb-12"
          >
          ...
          <motion.div 
            ...
            className="mt-32 w-full max-w-3xl h-64 relative border border-white/5 bg-[#050505] backdrop-blur-md rounded-2xl overflow-hidden flex items-center justify-center shadow-2xl"
          >
        ...
        <div className="relative w-full flex">
          ...
          <div className="flex whitespace-nowrap animate-marquee py-4">
            {technologies.map((tech, i) => (
              <span key={i} className="font-mono text-xl md:text-3xl text-primary/30 mx-12 tracking-widest hover:text-primary transition-colors duration-300">
                {tech}
              </span>
            ))}
          </div>
      ...
      <section className="py-40 px-6 max-w-7xl mx-auto relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
          ...
          <div className="lg:col-span-7 relative group">
            ...
            <div className="bg-[#050505] border border-white/5 rounded-3xl p-10 md:p-12 transition-all duration-700 relative z-10 h-[560px] flex flex-col hover:border-secondary/30 shadow-2xl">
